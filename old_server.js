...
passport.use(new LocalStrategy(function(username, password, done) {
  dbAPI.getUser(username).then(function(data) {
      var user = data;
      if(user === null) {
...
passport.deserializeUser(function(username, done) {
  dbAPI.getUser(username).then(function(user) {
      done(null, user);
   });
});
